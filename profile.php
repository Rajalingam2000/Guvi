...
<body class="profile_body">
    ...
    <div class="fix_main">
    <div class="Nav_all">
    <p class="welcome-message">Welcome Profile page...</p>
    ...
    <!-- <div class="profile_name"> 
        ...
        <h1>Profile</h1>
        <p class="welcome-message">Hello <?php echo $USERNAME ?></p>
    </div>  
    ...
    <div class="part1">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" value="<?php echo $DOB ?>" id="exampleFormControlInput1" name="Dob" ><br>
        <!-- <div class="mb-3"> -->
            <label for="Gender" class="form-label">Gender</label>
            <input type="text" class="form-control"  value="<?php echo $GENDER ?>" id="exampleFormControlInput1" name="Gender" placeholder="Gender"><br>
        <!-- </div>
        <div class="mb-3"> -->
            <label for="Contact" class="form-label">Contact</label>
            <input type="number" class="form-control" value="<?php echo $CONTACT ?>" id="exampleFormControlInput1" name="Contact" placeholder="Mobile Number"><br>
        <!-- </div> -->
        <!-- <div class="mb-3"> -->
        ...
        <button type="submit_1" class="btn btn-primary" onclick="Update()">Update</button id="but">
        </div>     
