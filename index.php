...
<div class="Nav_index">
    <h1>Login / Signup </h1>
            ...
            <div class="welcome-container">
                <h1 class="welcome-heading">Welcome to Our Guvi Internship Project</h1>
                    <p class="welcome-quote">"Learning Today, Leading Tomorrow"</p>
            </div>
...
<div class="login-text">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="FullName" placeholder="Ex: Raja">
    </div>
    <div class="mb-3">
